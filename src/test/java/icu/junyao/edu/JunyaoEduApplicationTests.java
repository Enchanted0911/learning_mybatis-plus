...
@SpringBootTest
class JunyaoEduApplicationTests {
    ...
    public void updateUser() {
        ...
        User user = new User();
        user.setId(1401707093194469377L);
        user.setAge(18);
    ...
    public void testOptimisticLocker() {
        //根据id查询数据
        User user = userMapper.selectById(1401707093194469377L);
        //进行修改
        user.setAge(111);
    ...
    public void testDeleteById(){
        int result = userMapper.deleteById(1401714128279621634L);
